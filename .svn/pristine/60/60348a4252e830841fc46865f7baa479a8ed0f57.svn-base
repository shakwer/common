...
public class HttpClientUtils {
  ...
  public static String postDataUrl(String url, String charset,JSONObject data) throws Exception {
    return requestUrl(url, connectTimeout, readTimeout, charset, HttpRequestMethod.POST, data);
  }
  ...
  public static String requestUrl(String url, int connectTimeout, int readTimeout, String charset,
                                  ...
                                  Object postParameter) throws Exception {
    ...
    try {
      ...
      if (httpRequestMethod.equals(HttpRequestMethod.POST)) {
        ...
        if (object instanceof JSONObject) {
          ...
          Map<String, String> postParameter = (Map<String, String>) object;
